...
impl Ticket {
    ...
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::assert_title(&title);
        Ticket::assert_description(&description);
        Ticket::assert_status(&status);
    ...
    pub fn set_description(&mut self, new_description: String) {
        Ticket::assert_description(&new_description);
    ...
    pub fn set_status(&mut self, new_status: String) {
        Ticket::assert_status(&new_status);
